...
STATUS_NOTES = {
    ...
    # API отвечает, но с августа 2026 не отдаёт полей, по которым виден
    # статус (см. betboom.api_info_to_status) — «не ответил» ввело бы в
    # заблуждение: ссылка при этом вполне может быть живой.
